...
#include "../define.h"
#include "./managerCredential.h"

// Function Prototypes =================================

bool login_handler(int role, int connFD, struct Customer *ptrToCustomer, struct Employee *ptrToEmployeeID);
...
bool login_handler(int role, int connFD, struct Customer *ptrToCustomerID, struct Employee *ptrToEmployeeID)
{
